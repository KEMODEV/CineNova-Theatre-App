    ...
    <main className='size-full pb-20 mt-[8.65rem] sm:mt-[9.15rem] md:mt-[10.65rem]'>
        ...
        >
          <div className='flex flex-col justify-center items-center bg-[rgba(111,111,111,0.5)] rounded-[0.94rem] w-[90%] sm:w-[85%] md:w-[80%] lg:w-[75%] max-w-[60rem] h-[90%] md:h-[95%] text-white'>
            <h2
              className='text-[1.1rem] sm:text-[1.3rem] md:text-[1.5rem] lg:text-[1.75rem] xl:text-[2rem] font-bold mt-4 sm:mt-6 md:mt-5 lg:mt-7 ml-8 md:ml-20 mr-0 md:mr-16 leading-7 md:leading-8 lg:leading-[38px] xl:leading-[45px] drop-shadow-2 max-w-64xl text-balance'
        ...
        <article 
          ...
          className='movie-section flex flex-col justify-center items-center max-w-[1200px] mt-12 mx-5 md:mx-20 pt-7 bg-[#fb424200]  border-0 dark:border-4 border-[#ff5b5ba9] dark:border-[#ffe0e0] rounded-xl dark:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_10px_#fb4242,0_0_20px_#fb4242,0_0_40px_#fb4242]'
        >
          <h1 
        ...
        <article 
          ref={setMovieSectionsRef}
          className='movie-section flex flex-col justify-center items-center max-w-[1200px] mt-12 mx-5 md:mx-20 pt-7 bg-[#fb424200]  border-0 dark:border-4 border-[#9e42fb67] dark:border-[#eddbff] rounded-xl dark:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_10px_#9F42FB,0_0_20px_#9F42FB,0_0_40px_#9F42FB]'
        >
          <h1 
