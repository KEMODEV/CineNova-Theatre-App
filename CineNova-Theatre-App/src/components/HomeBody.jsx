    ...
    <main className='size-full dark:bg-[#192734]'>
          ...
          <div className='flex flex-col justify-center items-center bg-[rgba(111,111,111,0.5)] rounded-[0.94rem] w-[85%] md:w-[80%] lg:w-[75%] max-w-[60rem] h-[90%] md:h-[95%] text-white'>
            ...
            <div className='flex h-full'>
              ...
              >
                ...
                <li>And many more technological advances revolutionizing cinema
                </li>
              </ul>
            </div>
          </div>
        ...
        <article className='flex flex-col justify-center items-center mt-8 mx-20'>
          <h1 
            ...
            style={ props.darkMode ? { textShadow: "#FFF 1px 1px" } : { textShadow: "#000 2px 2px" } }
          >
            Now Playing
          </h1>
          <hr className='box-content border-[#192734bd] dark:border-[#FFF] border-t-2 border-b-2 text-[1.2rem] px-44 mt-3 rounded-[6px]' />
          ...
          <section className='grid grid-cols-2 lg:grid-cols-3 gap-y-14 grid-flow-row-dense place-items-center w-full mt-16 mb-24 lg:px-1 xl:px-20 2xl:px-60'>
            <div className='w-32 sm:w-[9rem] lg:w-48 xl:w-52 2xl:w-52 text-center cursor-pointer hover:drop-shadow-[0_10px_10px_rgba(255,255,0,0.5)] transition duration-300 ease-in-out'>
              <img 
                src='src/images/posters/now_playing/dracula_movie_poster.jpg' 
                className='w-full h-auto'
              />
              <p className='bg-gray-300 dark:bg-gray-700 text-[#000] dark:text-white px-1 lg:px-2 py-2 text-lg lg:text-xl xl:text-2xl font-semibold rounded-b-lg line-clamp-2 hover:line-clamp-3'>Dracula</p>
            </div>
            <div className='w-32 sm:w-[9rem] lg:w-48 xl:w-52 2xl:w-52 text-center cursor-pointer hover:drop-shadow-[0_10px_10px_rgba(255,255,0,0.5)] transition duration-300 ease-in-out'>
              <img 
                ...
                className='w-full h-auto'
              />
              <p className='bg-gray-300 dark:bg-gray-700 text-[#000] dark:text-white px-1 lg:px-2 py-2 text-lg lg:text-xl xl:text-2xl font-semibold rounded-b-lg line-clamp-2 hover:line-clamp-3'>The Mummy</p>
            </div>
            <div className='w-32 sm:w-[9rem] lg:w-48 xl:w-52 2xl:w-52 text-center cursor-pointer hover:drop-shadow-[0_10px_10px_rgba(255,255,0,0.5)] transition duration-300 ease-in-out'>
              <img 
                ...
                className='w-full h-auto'
              />
              <p className='bg-gray-300 dark:bg-gray-700 text-[#000] dark:text-white px-1 lg:px-2 py-2 text-lg lg:text-xl xl:text-2xl font-semibold rounded-b-lg line-clamp-2 hover:line-clamp-3'>Frankenstein</p>
            </div>
            <div className='w-32 sm:w-[9rem] lg:w-48 xl:w-52 2xl:w-52 text-center cursor-pointer hover:drop-shadow-[0_10px_10px_rgba(255,255,0,0.5)] transition duration-300 ease-in-out'>
              <img 
                ...
                className='w-full h-auto'
              />
              <p className='bg-gray-300 dark:bg-gray-700 text-[#000] dark:text-white px-1 lg:px-2 py-2 text-lg lg:text-xl xl:text-2xl font-semibold rounded-b-lg line-clamp-2 hover:line-clamp-3'>The Invisible Man</p>
            </div>
          </section>
        </article>
          ...
          <section className='grid grid-cols-2 lg:grid-cols-3 gap-y-14 grid-flow-row-dense place-items-center w-full mt-16 mb-24 lg:px-1 xl:px-20 2xl:px-60'>
            <div className='w-32 sm:w-[9rem] lg:w-48 xl:w-52 2xl:w-52 text-center cursor-pointer hover:drop-shadow-[0_10px_10px_rgba(255,255,0,0.5)] transition duration-300 ease-in-out'>
              <img 
                ...
                className='w-full h-auto'
              />
              <p className='bg-gray-300 dark:bg-gray-700 text-[#000] dark:text-white px-1 lg:px-2 py-2 text-lg lg:text-xl xl:text-2xl font-semibold rounded-b-lg line-clamp-2 hover:line-clamp-3'>Creature from the Black Lagoon</p>
            </div>
            <div className='w-32 sm:w-[9rem] lg:w-48 xl:w-52 2xl:w-52 text-center cursor-pointer hover:drop-shadow-[0_10px_10px_rgba(255,255,0,0.5)] transition duration-300 ease-in-out'>
              <img 
                ...
                className='w-full h-auto'
              />
              <p className='bg-gray-300 dark:bg-gray-700 text-[#000] dark:text-white px-1 lg:px-2 py-2 text-lg lg:text-xl xl:text-2xl font-semibold rounded-b-lg line-clamp-2 hover:line-clamp-3'>The Invisible Man Returns</p>
            </div>
          </section>
